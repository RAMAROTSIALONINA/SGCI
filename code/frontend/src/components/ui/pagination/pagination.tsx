...
const Pagination = ({ className, ...props }: PaginationProps) => (
  <nav
    ...
    className={cn(paginationRootStyles(), className)}
    {...props}
  />
);
...
const PaginationContent = React.forwardRef<HTMLUListElement, PaginationContentProps>(
  ({ className, ...props }, ref) => (
    <ul ref={ref} className={cn(paginationListStyles(), className)} {...props} />
  ),
);
...
const PaginationItem = React.forwardRef<HTMLLIElement, PaginationItemProps>(
  ({ className, ...props }, ref) => (
    <li ref={ref} className={cn(paginationItemStyles(), className)} {...props} />
  ),
);
