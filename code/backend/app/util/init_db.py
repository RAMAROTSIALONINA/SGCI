...
from app.db.models.history import History  # Import all models here
from app.db.models.notification import Notification  # Import all models here
...
from app.db.models.user_preference import UserPreference  # Import all models here
